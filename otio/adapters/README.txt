...
Note that the current Windows version of OTIO has a bug in splitting the OTIO_PLUGIN_MANIFEST_PATH on colons instead of on semicolons.  You can fix it if you install the beta of opentimelineio, with:
    pip install opentimelineio --pre

In it, the following file:

C:/Users/%USERNAME%/AppData/Local/Programs/Python/Python%PYTHONVERSION%/Lib/site-packages/opentimelineio/plugins/manifest.py
