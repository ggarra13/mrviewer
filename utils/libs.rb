...
FileUtils.cp_r( "../../HISTORY.txt", "Release/HISTORY.txt" )
FileUtils.cp_r( "../../LICENSE.txt", "Release/LICENSE.txt" )
FileUtils.cp_r( "../../Videos.txt", "Release/Videos.txt" )
