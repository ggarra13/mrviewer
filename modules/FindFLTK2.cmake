...
# If FLTK2_INCLUDE_DIR is a# lready defined we assigne its value to FLTK2_DIR
...
IF(NOT FLTK2_DIR)
  ...
  IF(NOT FLTK2_DIR) 
    FIND_PATH(FLTK2_DIR fltk/run.h ${FLTK2_INCLUDE_SEARCH_PATH} /usr/local/include)
  ENDIF(NOT FLTK2_DIR)
...
IF(FLTK2_DIR)
  ...
  IF(FLTK2_BUILT_WITH_CMAKE)
    ...
    IF( CMAKE_BUILD_TYPE STREQUAL "Debug" )
    	...
    	FIND_LIBRARY(FLTK2_BASE_LIBRARY NAMES fltk2dlld fltk2
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
      	FIND_LIBRARY(FLTK2_GL_LIBRARY NAMES fltk2dll_gld fltk2_gl
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
        FIND_LIBRARY(FLTK2_IMAGES_LIBRARY NAMES fltk2dll_imagesd fltk2_images
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
    ...
    IF( CMAKE_BUILD_TYPE STREQUAL "Debug" )
		...
		SET(FLTK2_IMAGES_LIBS ${FLTK2_IMAGES_LIBS} fltk2_jpegd)
    	  ENDIF(FLFLTK2_USE_SYSTEM_JPEG)
    	  IF(FLFLTK2_USE_SYSTEM_PNG)
		SET(FLTK2_IMAGES_LIBS ${FLTK2_IMAGES_LIBS} fltk2_pngd)
    	  ENDIF(FLFLTK2_USE_SYSTEM_PNG)
    	  IF(FLFLTK2_USE_SYSTEM_ZLIB)
		SET(FLTK2_IMAGES_LIBS ${FLTK2_IMAGES_LIBS} fltk2_zlibd)
  ...
  ELSE(FLTK2_BUILT_WITH_CMAKE)
    ...
    IF( CMAKE_BUILD_TYPE STREQUAL "Debug" )
    	...
    	FIND_LIBRARY(FLTK2_BASE_LIBRARY NAMES fltk2d
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
      	FIND_LIBRARY(FLTK2_GL_LIBRARY NAMES fltk2_gld
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
        FIND_LIBRARY(FLTK2_IMAGES_LIBRARY NAMES fltk2_imagesd
      	PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
    ...
    FIND_LIBRARY(FLTK2_BASE_LIBRARY NAMES ${FLTK_BASE_LIBRARY}
      PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
    FIND_LIBRARY(FLTK2_GL_LIBRARY NAMES ${FLTK_GL_LIBRARY}
      PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
    FIND_LIBRARY(FLTK2_IMAGES_LIBRARY NAMES ${FLTK_IMAGES_LIBRARY}
      PATHS ${FLTK2_LIBRARY_SEARCH_PATH})
...
IF(FLTK2_FOUND)
  SET(FLTK2_LIBRARIES ${FLTK2_IMAGES_LIBRARY} ${FLTK2_GL_LIBRARY} ${FLTK2_IMAGES_LIBS} ${FLTK2_BASE_LIBRARY}  )
  IF(APPLE)
  ...
  MESSAGE( "FLTK2 LIBS=" ${FLTK2_LIBRARIES} )
