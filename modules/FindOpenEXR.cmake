...
FIND_LIBRARY( IlmImfUtil 
  NAMES IlmImfUtil-2_3 IlmImfUtil_dll IlmImfUtil_dll_d IlmImfUtil IlmImfUtild
  PATHS ${SEARCH_DIRS}
  DOC   "OpenEXR IlmImf library"
)

FIND_LIBRARY( IlmImf 
  NAMES IlmImf-2_3 IlmImf_dll IlmImf_dll_d IlmImf IlmImfd
  PATHS ${SEARCH_DIRS}
  DOC   "OpenEXR IlmImf library"
)
...
FIND_LIBRARY( Imath 
  NAMES Imath-2_3 Imath_dll Imath_dll_d Imath Imathd 
  PATHS ${SEARCH_DIRS}
  DOC   "OpenEXR Imath library"
)

FIND_LIBRARY( Iex
  NAMES Iex-2_3 Iex_dll Iex_dll_d Iex Iexd libIex Iex-2_1
  PATHS ${SEARCH_DIRS}
  DOC   "OpenEXR Iex library"
)

FIND_LIBRARY( IexMath
  NAMES IexMath-2_3 IexMath
  PATHS ${SEARCH_DIRS}
  DOC   "OpenEXR IexMath library"
)

FIND_LIBRARY( Half
  NAMES Half-2_3 Half_dll Half_dll_d Half Halfd
  PATHS ${SEARCH_DIRS}
