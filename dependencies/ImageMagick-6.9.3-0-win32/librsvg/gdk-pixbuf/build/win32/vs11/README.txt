...
b) Build them yourself with VS11 (but you may most probably wish to get
   ...
   is built using the win32/Makefile.msc makefile with VS11 with the ASM routines
...
<root>\gdk-pixbuf\<this-gdk-pixbuf-source-tree>\build\win32\vs11\README.

<PlatformName> is either Win32 or x64, as in the VS11 project files.
...
instructions in <root>\glib<-version>\build\win32\vs11, so that the required
headers, EXEs, DLLs and LIBs will end up in
<root>\vs11\<PlatformName>\include\glib-2.0 (headers)
<root>\vs11\<PlatformName>\lib (LIBs, also glib-2.0/include/glibconfig.h)
...
<root>\vs11\<PlatformName>\lib and GDK-Pixbuf headers into
<root>\vs11\<PlatformName>\include\GDKPixbuf-2.0. This is then from where
