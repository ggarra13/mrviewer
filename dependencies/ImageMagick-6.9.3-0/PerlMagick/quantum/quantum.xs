...
#define PackageName   "Image::Magick::Q32HDRI"
#if PERL_VERSION <= 6
#define PerlIO  FILE
...
typedef void
  *Image__Magick__Q32HDRI;  /* data type for the Image::Magick::Q32HDRI package */

/*
  Static declarations.
*/
...
%
*/
MODULE = Image::Magick::Q32HDRI PACKAGE = Image::Magick::Q32HDRI
...
void
Animate(ref,...)
  Image::Magick::Q32HDRI ref = NO_INIT
  ALIAS:
    AnimateImage  = 1
    animate       = 2
    animateimage  = 3
