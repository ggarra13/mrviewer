...
bootstrap Image::Magick::Q32HDRI $VERSION;
...
{
    my $this = shift;
    my $class = ref($this) || $this || "Image::Magick::Q32HDRI";
    my $self = [ ];
    bless $self, $class;
    $self->set(@_) if @_;
    return $self;
...
Image::Magick::Q32HDRI - objected-oriented Perl interface to ImageMagick (Q32HDRI). Use it to create, edit, compose, or convert bitmap images from within a Perl script.

=head1 SYNOPSIS

  use Image::Magick::Q32HDRI;
  $p = new Image::Magick::Q32HDRI;
  $p->Read("imagefile");
