...
use parent qw/Image::Magick::Q32HDRI/;
...
Image::Magick - objected-oriented Perl interface to ImageMagick for default quantum (Q32HDRI). Use it to read, manipulate, or write an image or image sequence from within a Perl script.
