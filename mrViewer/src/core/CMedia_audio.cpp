                                      ...
                                      bool& got_subtitle )
{
    ...
    boost::int64_t first = first_frame() + _audio_offset;
...
{ 
    ...
    if ( _audio_index == -1 ) return kDecodeNoStream;
...
void CMedia::do_seek()
{
  ...
  boost::int64_t x = _seek_frame + _audio_offset;
