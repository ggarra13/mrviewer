...
"#const c[19] = 2 3 4 5\n"
"#const c[20] = 6 2.718282 2.71875 0.69335938\n"
"#default mask = 0\n"
...
"POW R0.x, c[20].z, R2.x;\n"
"POW R0.z, c[20].z, R2.z;\n"
"POW R0.y, c[20].z, R2.y;\n"
...
"MAD R2.xyz, R3, c[20].w, R1.w;\n"
"MUL R1.x, R1, c[12];\n"
"CMP R2.xyz, -R1.x, R2, R0;\n"
"TEX R0.xyz, R2, texture[3], 3D;\n"
"RCP R1.y, R0.w;\n"
"POW R0.x, c[20].y, R0.x;\n"
"POW R0.z, c[20].y, R0.z;\n"
"POW R0.y, c[20].y, R0.y;\n"
"CMP R0.xyz, -R1.x, R0, R2;\n"
"ABS R2.x, R0.w;\n"
"CMP R1.x, -R2, c[18].z, c[18].w;\n"
"MOV R2.y, c[18].z;\n"
"ADD R2.z, -R2.y, c[6].x;\n"
"MUL R3.xyz, R0, R1.y;\n"
"MUL R1.x, R1, c[7];\n"
...
"CMP R2.x, -R2, c[18].w, c[18].z;\n"
"POW R0.y, R0.y, c[5].x;\n"
"POW R0.z, R0.z, c[5].x;\n"
"POW R0.x, R0.x, c[5].x;\n"
"CMP R0.xyz, -R2.z, R0, R0.x;\n"
"CMP R2.z, -R2, c[18].w, c[18];\n"
"ABS R2.z, R2;\n"
"CMP R2.z, -R2, c[18].w, c[18];\n"
"MUL R3.x, R2.z, R2.w;\n"
"CMP R0.xyz, -R3.x, R0.y, R0;\n"
"ADD R3.x, -R1.y, c[6];\n"
"ABS R2.w, R2;\n"
"CMP R2.w, -R2, c[18], c[18].z;\n"
"ABS R3.x, R3;\n"
...
"MUL R2.w, R2.z, R3.x;\n"
"CMP R0.xyz, -R2.w, R0.z, R0;\n"
"ADD R2.w, -R1.z, c[6].x;\n"
"ABS R1.z, R3.x;\n"
"ABS R2.w, R2;\n"
"CMP R1.z, -R1, c[18].w, c[18];\n"
"MUL R1.z, R2, R1;\n"
"CMP R2.w, -R2, c[18], c[18].z;\n"
"MUL R2.z, R1, R2.w;\n"
"CMP R0.xyz, -R2.z, R0.w, R0;\n"
"ADD R2.z, -R1.w, c[6].x;\n"
"ABS R1.w, R2;\n"
"ABS R2.z, R2;\n"
"MUL R3.x, R0, c[18];\n"
"CMP R2.w, -R2.z, c[18], c[18].z;\n"
"CMP R1.w, -R1, c[18], c[18].z;\n"
"MUL R2.z, R1, R1.w;\n"
"MUL R1.z, R2, R2.w;\n"
"CMP R0.x, -R1.z, R3, R0;\n"
"MAD R1.w, R0, c[18].x, R0.x;\n"
"CMP R0.x, -R1.z, R1.w, R0;\n"
"ADD R1.z, -R2.y, c[0].x;\n"
"ADD R1.w, R0.x, R0.y;\n"
"ABS R2.w, R2;\n"
"CMP R2.w, -R2, c[18], c[18].z;\n"
...
"ADD R2.y, R1.w, R0.z;\n"
"ABS R1.z, R1;\n"
"CMP R1.w, -R1.z, c[18], c[18].z;\n"
"MUL R3.x, R1.w, R2;\n"
"CMP R3.z, -R3.x, c[18], R0.w;\n"
"MUL R2.x, R2.y, c[18].y;\n"
"ABS R2.y, R3.z;\n"
"ADD R0.w, -R1.x, c[0].x;\n"
"ABS R1.x, R0.w;\n"
"CMP R3.x, -R1, c[18].w, c[18].z;\n"
"CMP R3.y, -R2, c[18].w, c[18].z;\n"
"ABS R0.w, R1;\n"
"CMP R2.y, -R0.w, c[18].w, c[18].z;\n"
"MUL R0.w, R2.y, R3.x;\n"
"MUL R1.x, R0.w, R3.y;\n"
"MOV R3.y, c[20].x;\n"
"ADD R3.y, -R3, c[6].x;\n"
"ABS R3.y, R3;\n"
"CMP R3.y, -R3, c[18].w, c[18].z;\n"
"MUL R2.z, R2, R3.y;\n"
"CMP R0.xyz, -R2.z, R2.x, R0;\n"
"CMP R1.x, -R1, c[18].z, R3.z;\n"
"ABS R2.z, R3.x;\n"
"ADD R2.w, -R1.y, c[0].x;\n"
"CMP R1.y, -R2.z, c[18].w, c[18].z;\n"
"ABS R2.z, R2.w;\n"
"MUL R2.y, R2, R1;\n"
"MUL R1.y, fragment.texcoord[0], c[2].x;\n"
"MUL R2.w, fragment.texcoord[0].x, c[3].x;\n"
"CMP R2.z, -R2, c[18].w, c[18];\n"
"FLR R3.y, R1;\n"
"FLR R3.x, R2.w;\n"
"MUL R2.y, R2, R2.z;\n"
...
"MUL R3.x, R3, c[19];\n"
"CMP R3.x, -R1.y, R3, -R3;\n"
"SLT R1.y, R2.w, c[18].w;\n"
"ABS R3.y, R3.x;\n"
"FLR R1.w, R1;\n"
"FLR R3.y, R3;\n"
"SLT R2.w, R3.x, c[18];\n"
"CMP R2.w, -R2, -R3.y, R3.y;\n"
"CMP R1.z, -R1, c[18].w, R2.w;\n"
"CMP R1.y, -R1, -R1.w, R1.w;\n"
"CMP R1.y, -R0.w, R1, R1.z;\n"
"SLT R0.w, R2.z, c[18].z;\n"
"CMP R0.w, -R2.y, R0, R1.y;\n"
"CMP R1.y, -R2.x, c[18].w, c[18].z;\n"
"MUL R1.z, R2.y, R1.y;\n"
"ADD R0.w, R0, -c[1].x;\n"
"ABS R1.y, R0.w;\n"
"CMP R0.w, -R1.z, c[18].z, R1.x;\n"
"CMP R0, -R1.y, R0, c[18].w;\n"
"MUL R1.xyz, R0, R0.w;\n"
"CMP result.color.xyz, -c[8].x, R1, R0;\n"
"MOV result.color.w, R0;\n"
"END\n"
"# 215 instructions, 8 R-regs\n"
;
...
"MOVH  o[COLH].w, H0;\n"
"END\n"
"# 193 instructions, 2 R-regs, 8 H-regs\n"
;
